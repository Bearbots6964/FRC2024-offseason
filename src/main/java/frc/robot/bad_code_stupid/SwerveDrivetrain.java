 ...
 */
package frc.robot.bad_code_stupid;
...
public class SwerveDrivetrain {
  ...
  protected final AHRS m_pigeon2;
  protected final Supplier<Double> m_yawGetter;
  protected final Supplier<Double> m_angularVelocity;
  ...
  public SwerveDrivetrain(
    ...
    m_pigeon2 = new AHRS(SPI.Port.kMXP);
    m_yawGetter = new Supplier<Double>() {
      @Override
      public Double get() {
        return (double) m_pigeon2.getYaw();
      }
    };
    m_angularVelocity = new Supplier<Double>() {
      @Override
      public Double get() {
        return (double) m_pigeon2.getRate();
      }
    };
