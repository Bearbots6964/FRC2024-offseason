...
class VisionSubsystem(private var drivetrain: CommandSwerveDrivetrain) : SubsystemBase() {
    ...
    private val botToLeftCamera =
        Transform3d(Translation3d(0.0, 0.0, 0.0), Rotation3d(0.0, 0.0, 0.0)) // TODO get this value
    private val botToRightCamera =
        Transform3d(Translation3d(0.0, 0.0, 0.0), Rotation3d(0.0, 0.0, 0.0)) // TODO get this value
    ...
    private var rightPhotonPoseEstimator = PhotonPoseEstimator(
        aprilTagFieldLayout,
