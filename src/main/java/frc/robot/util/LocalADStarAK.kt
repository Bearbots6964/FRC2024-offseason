...
class LocalADStarAK : Pathfinder {
     ...
     *
     * @param constraints The path constraints to use when creating
     *    the path.
     * @param goalEndState The goal end state to use when creating
     *    the path.
     * @return The PathPlannerPath created from the points
     ...
     *
     * @param startPosition Start position on the field. If this is
     *    within an obstacle it will be moved to the nearest
     *    non-obstacle node.
     */
     ...
     *
     * @param goalPosition Goal position on the field. f this is
     *    within an obstacle it will be moved to the nearest
     *    non-obstacle node.
     */
     ...
     *    obstacles. Each [Translation2d] represents opposite
     *    corners of a bounding box.
     * @param currentRobotPos The current position of the robot.
     *    This is needed to change the start position of the path
